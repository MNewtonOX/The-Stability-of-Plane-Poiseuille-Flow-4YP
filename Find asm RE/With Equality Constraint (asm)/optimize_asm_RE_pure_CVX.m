...
% %L = zeros(2*(4*M+1)*(N-1),2*(4*M+1)*(N-1));
% L2 = kron(eye(2),(W*(-2*I)));
% L2 = L2(1:(4*M+1)*(N-1), 1:(4*M+1)*(N-1));
% 
% % Top left
% L((M*(N-1) + 1):(3*M+1)*(N-1), (M*(N-1) + 1):(3*M+1)*(N-1)) = ...
%     (W*(gamma*A1'*Q*E + A2'*Q*E + gamma*E'*Q*A1 + E'*Q*A2));
% 
% % Top right
% L((M*(N-1) + 1):(3*M+1)*(N-1), ((5*M+1)*(N-1) + 1):(7*M+2)*(N-1)) = ...
%     (W*(E'*Q - gamma*A1' - A2' - tau*I));
% 
% % Bottom left
% L(((5*M+1)*(N-1) + 1):(7*M+2)*(N-1), (M*(N-1) + 1):(3*M+1)*(N-1)) = ...
%     (W*(Q*E - gamma*A1 - A2 - tau*I));
% 
% % Bottom right
% L(((4*M+1)*(N-1) + 1):(2*(4*M+1)*(N-1)), ((4*M+1)*(N-1) + 1):(2*(4*M+1)*(N-1))) = ...
%     L2;
% 
% L + L' + eta2*ones(size(L)) <= 0 ;
% 
% % [ (W*(gamma*A1'*Q*E + A2'*Q*E + gamma*E'*Q*A1 + E'*Q*A2))...
% %   (W*(E'*Q - gamma*A1' - A2' - tau*I));...
% %   (W*(Q*E - gamma*A1 - A2 - tau*I))  ...         
